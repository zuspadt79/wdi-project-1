window.addEventListener("DOMContentLoaded", function(){
  ...
  var squareCombinations =  [ [0, 11, 21, 10], [1, 12, 22, 11], [2, 13, 23, 12], [3, 14, 24, 13], 
                              ...
                              [126, 137, 147, 136], [127, 138, 148, 137], [128, 139, 149, 138], [129, 140, 150, 139], 
    ...
    $.each(squareCombinations, function(i, winArray){
      ...
      $.each(winArray, function(j, value){
        if (!!~clickedLines.indexOf(value)) {
          ...
          if (winCounter === 4) {
            if (counter % 2 === 0) {
              $("div[data-value='" + winArray[3] + "']").addClass("playerOne-won"); 
              player1Score++;
              console.log(player1Score);
              checkForWin(player1Score, player2Score)
              counter++;
            } else {
              $("div[data-value='" + winArray[3] + "']").addClass("playerTwo-won");
              player2Score++;
